...
import com.soildersofcross.app.Adapter.ViewPagerAdapter;
import com.soildersofcross.app.Model_Class.Model_News;
import com.soildersofcross.app.R;
import com.soildersofcross.app.utils.DepthTransformation;
        ...
        tts = new TextToSpeech(CategoriesActivity.this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status != TextToSpeech.ERROR) {
                    ...
                    Toast.makeText(CategoriesActivity.this, "Language Not Suppourted !", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
//                            viewPagerAdapter.setLoaded();
    ...
    private void fB_Banner() {
        fb_banner = new com.facebook.ads.InterstitialAd(CategoriesActivity.this, bann_ads);
        fb_banner.loadAd();

        final com.facebook.ads.AdView adView = new com.facebook.ads.AdView(CategoriesActivity.this, bann_ads, com.facebook.ads.AdSize.BANNER_HEIGHT_50);
        adView.loadAd();
