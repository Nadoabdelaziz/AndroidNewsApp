...
public class ViewPagerAdapter3 extends RecyclerView.Adapter<ViewPagerAdapter3.ViewHolder>{
    ...
    public ViewPagerAdapter3(FragmentActivity activity_, ArrayList<NewsData> imageList, ViewPager2 viewPager2_) {
        try {
            activity = activity_;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        ItemsAdapter2 itemsAdapter = new ItemsAdapter2(activity, menuGetset.news);
/*
