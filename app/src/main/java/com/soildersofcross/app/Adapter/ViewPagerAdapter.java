...
import com.soildersofcross.app.Model_Class.Model_News;
...
//                Youtube image
           ...
           /* if (menuGetset.getIs_image().equals("0")) {
                try {
                    Glide.with(activity).load(imagePath + menuGetset.getImage()).apply(new RequestOptions().placeholder(R.drawable.placeholder)).into(holder.imageview2);
                    holder.img_play.setVisibility(View.VISIBLE);
                } catch (Exception e) {
                    e.getMessage();
                    Log.e(TAG, "onBindViewHolder: " + e.getMessage());
            ...
            if (menuGetset.getIs_image().equals("2")) {
                try {
                    Glide.with(activity).load(menuGetset.getImage()).apply(new RequestOptions().placeholder(R.drawable.placeholder)).into(holder.imageview2);
                    holder.img_playurL.setVisibility(View.VISIBLE);
