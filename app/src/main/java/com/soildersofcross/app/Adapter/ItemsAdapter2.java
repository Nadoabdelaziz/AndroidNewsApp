...
import com.soildersofcross.app.Activity.CommentActivity;
import com.soildersofcross.app.Activity.Detail_Activity;
import com.soildersofcross.app.Activity.FullImageActivity;
import com.soildersofcross.app.Activity.MainActivity;
import com.soildersofcross.app.Activity.ReferenceActivity;
...
import com.soildersofcross.app.utils.OnSwipeTouchListener;
...
public class ItemsAdapter2 extends RecyclerView.Adapter<ItemsAdapter2.ViewHolder> {
    ...
    public ItemsAdapter2(Activity activity_, ArrayList<NewsData.Model_News> imageList) {
        try {
            activity = activity_;
...
//                                holder.imgShareM2.setVisibility(View.VISIBLE);
    ...
    private void supportLan(String description , ItemsAdapter2.ViewHolder holder) {
...
//                                        btn_pause.setVisibility(View.INVISIBLE);
    ...
    private void addBookmark(NewsData.Model_News menuGetset, ItemsAdapter2.ViewHolder holder) {
        try {
    ...
    private void deleteData(NewsData.Model_News menuGetset, ItemsAdapter2.ViewHolder holder) {
    ...
    private void btnPlayTheme(ItemsAdapter2.ViewHolder holder) {
        if (MainActivity.themeKEY != null) {
            if (MainActivity.themeKEY.equals("1")) {
    ...
    private void insertData(NewsData.Model_News menuGetset, ItemsAdapter2.ViewHolder holder) {
        try {
            SqliteHelper sqliteHelper = new SqliteHelper(activity);
            SQLiteDatabase db1 = sqliteHelper.getWritableDatabase();
    ...
    private void speakOut(ItemsAdapter2.ViewHolder holder) {
   ...
   /* public void addItem(ArrayList<Model_News> item, int size) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            relay_Bott = itemView.findViewById(R.id.relay_Bott);


            linRef.setVisibility(View.GONE);
